...
import fr.paquet.activite.RessourceRessouces;
import fr.paquet.ihm.alert.AlertType;
import fr.paquet.ihm.alert.AlertWindow;
import fr.paquet.ihm.commun.JPanelListJLabelButton;

public class ActivitePanelConceptionRessources extends JPanelListJLabelButton {
	...
	public ActivitePanelConceptionRessources(ActivitePanelConception activitePanelConception) {
		super("Ressources", activitePanelConception);

	}

	@Override
	protected List<? extends Ressource> getRessources() {
		return getActivite().getRessources();
	...
	public void addRessouce(String text, String url) {
		try {
			...
			getActivite().AddRessource(new RessourceRessouces(text, url, getActivite()));
			affiche();
		} catch (Exception e) {
	...
	public void removeRessouce(String text, String url) {
		try {
			getActivite().RemoveRessource(new RessourceRessouces(text, url, getActivite()));
