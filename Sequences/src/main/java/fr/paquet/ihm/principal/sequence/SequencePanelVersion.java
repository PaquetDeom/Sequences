...
public class SequencePanelVersion extends JPanel {
	...
	public SequencePanelVersion(SequencePanel sequencePanel) {
		...
		JLabel label = new JLabel("Nom de la séquence : ");
		add(label, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
		...
		add(getLabelVersion(), new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		add(new JLabel("Nom de l'auteur : "), new GridBagConstraints(4, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		add(getLabelAuteur(), new GridBagConstraints(5, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		add(new JPanel(), new GridBagConstraints(5, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
	...
	private JLabel getLabelAuteur() {
		if (getSequencePanel().getOngletSequence().getMainOnglet().getSequence().getVersionSequence()
				.getAuteur() == null)
			return new JLabel(" | ");
		else
			return new JLabel(getSequencePanel().getOngletSequence().getMainOnglet().getSequence().getVersionSequence()
					.getAuteur().getNom() + " "
	...
	private JLabel getLabelVersion() {
		if (getSequencePanel().getOngletSequence().getMainOnglet().getSequence().getVersionSequence() == null)
			return new JLabel(" | ");
		else
			return new JLabel("N°" + getSequencePanel().getOngletSequence().getMainOnglet().getSequence()
