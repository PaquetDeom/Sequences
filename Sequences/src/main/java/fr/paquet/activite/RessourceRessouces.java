...
public class RessourceRessouces extends Ressource {

	public RessourceRessouces(String text, String url, Activite_1 activite) throws Exception {
		super(text, url, activite);

	}

	public RessourceRessouces() {
		super();
	}
